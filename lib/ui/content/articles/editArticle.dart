                    ...
                    children: [
                      ...
                      CircleAvatar(
                        ...
                        child: IconButton(
                          ...
                          onPressed: () {
                            controla
                                .editArticle(controla.listaArticlesFinal![controla.listaArticlesFinal![0].idfinal].id.toString(),foto.text, detalle.text, codigo.text,controlu.listaUserLogin![0].id.toString())
                                .then((value) {
                              Get.snackbar(
